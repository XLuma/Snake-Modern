...
1. Clone
2. `nvm use`
3. `cd server && cp .env-dist .env`
4. Setup the env with your proper db url
5. `npm install`
6. `npm run dev`
...
- Graphical assets (logo, fruits, cards, other various game assets) belong to Motion Twin and are licensed under the CC-BY-SA-4.0 license.
