...
<h1
  style="background: url({header}) center bottom / 900px 100px no-repeat;"
  class="relative mx-auto mt-8 -mb-4.5 box-border block h-25 max-width-900 text-center text-transparent img-rendering-pixelated"
>
  Snake
</h1>
<nav
